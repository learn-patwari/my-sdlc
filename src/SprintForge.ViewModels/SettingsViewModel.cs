...
public sealed partial class SettingsViewModel : ObservableObject
{
    ...
    public bool IsGeneralTabActive     => ActiveTab == "General";
    public bool IsJiraTabActive        => ActiveTab == "Jira";
    public bool IsAiTabActive          => ActiveTab == "AI";
    public bool IsRepositoriesTabActive => ActiveTab == "Repositories";
    public bool IsSrsTabActive         => ActiveTab == "SRS";
    public bool IsSprintTabActive      => ActiveTab == "Sprint";
    public bool IsTestingTabActive     => ActiveTab == "Testing";
    public bool IsPreferencesTabActive => ActiveTab == "Preferences";
    ...
    partial void OnActiveTabChanged(string value)
    {
        ...
        OnPropertyChanged(nameof(IsRepositoriesTabActive));
        OnPropertyChanged(nameof(IsSrsTabActive));
        OnPropertyChanged(nameof(IsSprintTabActive));
        OnPropertyChanged(nameof(IsTestingTabActive));
        OnPropertyChanged(nameof(IsPreferencesTabActive));
    }

    // ── General ─────────────────────────────────────────────────────────────
    [ObservableProperty] private string _profileName      = "Default";
    [ObservableProperty] private string _workingDirectory =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "SprintForgeBeta");
    ...
    public string ConnectionBgHex => IsConnected ? "#052e16" : "#1A2235";
    public string ConnectionFgHex => IsConnected ? "#22C55E" : "#64748B";

    partial void OnIsConnectedChanged(bool value)
    {
        OnPropertyChanged(nameof(ConnectionBgHex));
        OnPropertyChanged(nameof(ConnectionFgHex));
    }
    ...
    public bool IsSprintPlanTextSource       => SprintPlanSource == "Text";
    public bool IsSprintPlanConfluenceSource => SprintPlanSource == "Confluence";

    partial void OnSprintPlanSourceChanged(string value)
    {
        OnPropertyChanged(nameof(IsSprintPlanTextSource));
        OnPropertyChanged(nameof(IsSprintPlanConfluenceSource));
    }
